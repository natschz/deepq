...
net = deepqnet.DeepQNet([500], 4*history_length, 2, batch_size=50, gamma=0.9, learning_rate=learning_rate, min_observations=500, max_observations=1500, epsilon_decay=0.005, min_epsilon=0.005, max_steps=1000, training_dropout=1)
