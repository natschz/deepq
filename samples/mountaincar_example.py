...
net = deepqnet.DeepQNet([250], input_length*history_length, 2, batch_size=50, gamma=0.9, learning_rate=1e-3, min_observations=500, max_observations=15000, epsilon_decay=0.01, min_epsilon=0.05, epsilon=0.05, max_steps=1500)
